...
export function StylizedImage({ shape = 0, className, ...props }: ImagePropsWithOptionalAlt & { shape?: 0 | 1 | 2 }) {
  const id = useId()
    ...
    <div className={clsx(className, 'relative flex aspect-719/680 w-full')}>
      <svg viewBox={`0 0 ${width} ${height}`} fill="none" className="h-full">
        <g clipPath={`url(#${id}-clip)`} className="group">
          <g className="origin-center scale-100 grayscale transition duration-500 hover:grayscale-75 motion-safe:group-hover:scale-105">
