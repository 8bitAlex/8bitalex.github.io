...
export default function Testimonial(props: Props) {
  return (
    <div className={clsx('relative mx-auto px-6 md:max-w-2xl md:px-0 lg:max-w-7xl lg:px-8', props.className)}>
      <figure className="grid grid-cols-1 items-center gap-x-0 gap-y-4 sm:gap-x-6 lg:gap-x-10">
        ...
        <div className="xs:w-full col-end-1 sm:row-span-4 sm:w-64 lg:w-72">
          <ProfileCard image={props.image} name={props.text} subtext={props.subtext} textClassName="sm:invisible" />
        </div>
