...
export const post = {
  ...
  description:
    'Five ways to create a Raid profile — interactive wizard, hand-written YAML, an existing raid.yaml, a Git URL, or a raw file URL — with the trade-offs and when to pick each.',
  tags: ['Raid', 'Tutorial']
}
